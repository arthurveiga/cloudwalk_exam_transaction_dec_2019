...
*Stop credit card fraud: Implement the concept of a simple anti-fraud using Ruby on Rails.*

An Anti-fraud works by receiving information about a transaction and inferring whether it is a fraudulent transaction or not before authorizing it. Please use the data provided on challenge 2 to test your solution.
